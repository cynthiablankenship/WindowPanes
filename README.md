...
```text
dist/WindowPanes-Setup-0.2.8.exe
```
...
```text
dist/WindowPanes-0.2.8-arm64.dmg
```
...
```text
dist/WindowPanes-0.2.8-x86_64.AppImage
```

On Linux, make the AppImage executable and run it:

```bash
chmod +x dist/WindowPanes-0.2.8-x86_64.AppImage
./dist/WindowPanes-0.2.8-x86_64.AppImage
```
...
- [ ] On macOS, run `npm run dist:mac:gemstone` and confirm `dist/WindowPanes-0.2.8-arm64.dmg` is created.
- [ ] Run `npm run package:win:gemstone` and launch `dist/win-unpacked/WindowPanes.exe`.
- [ ] Run `npm run dist:win:gemstone` and confirm `dist/WindowPanes-Setup-0.2.8.exe` is created.
- [ ] On Linux, run `npm run package:linux:gemstone` and launch `dist/linux-unpacked/WindowPanes`.
- [ ] On Linux, run `npm run dist:linux:gemstone`, then `chmod +x dist/WindowPanes-0.2.8-x86_64.AppImage` and launch the AppImage.
