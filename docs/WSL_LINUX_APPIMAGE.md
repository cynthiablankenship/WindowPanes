...
```powershell
wsl -d Ubuntu-24.04 -- bash -lc "cp ~/src/WindowPanes/dist/WindowPanes-0.2.2-x86_64.AppImage /mnt/c/path/to/WindowPanes/dist/"
```
...
```text
C:\path\to\WindowPanes\dist\WindowPanes-0.2.2-x86_64.AppImage
```
