...
For version `0.2.3`, the expected installer name is:

```text
WindowPanes-Setup-0.2.3.exe
```
...
For version `0.2.3`, the expected AppImage name is:

```text
WindowPanes-0.2.3-x86_64.AppImage
```
