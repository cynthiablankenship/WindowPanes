...
For version `0.2.4`, the expected installer name is:

```text
WindowPanes-Setup-0.2.4.exe
```
...
For version `0.2.4`, the expected AppImage name is:

```text
WindowPanes-0.2.4-x86_64.AppImage
```
